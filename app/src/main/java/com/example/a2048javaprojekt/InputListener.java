...
/**
 * Klasa odpowiadająca za obsługe wejścia
 */
class InputListener implements View.OnTouchListener {
    ...
    /**
     * Obsługuje wykonanie odpowiedniej akcji po wykonaniu odpowiedniego gestu, bądź kliknięciu w odpowiedni przycisk
     * @param view Widok
     * @param event Event związany z poruszaniem palcem po ekranie
     * @return zwraca true w przypadku powodzenia
     */
                    ...
                    if (iconPressed(mView.sXNewGame, mView.sYIcons)) {
                        if (!mView.game.gameLost()) {
                            new AlertDialog.Builder(mView.getContext())
                                    .setPositiveButton("Wyzeruj", new DialogInterface.OnClickListener() {
                                        @Override
                                    ...
                                    .setTitle("Wyzerować gre?")
                                    .setMessage("Czy na pewno chcesz wyzerować grę i zacząć od nowa?")
                                    .show();
                        } else {
                            mView.game.newGame();
                        }
     ...
     * @param sx pozycja x
     * @param sy pozycja y
     * @return sprawdza czy ikona zostala wcisnieta
     */
    ...
    /**
     * @param starting poczatkowa granica
     * @param check liczba do sprawdzenia
     * @param ending końcowa granica
     * @return sprawdza, czy dana pozycja jest w granicach
     */
